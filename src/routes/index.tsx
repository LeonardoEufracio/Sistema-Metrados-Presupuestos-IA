        ...
        <div className="relative mx-auto max-w-7xl px-6 py-20 md:py-28">
          <div className="space-y-8 max-w-3xl">
            ...
            <p className="max-w-xl text-base text-muted-foreground md:text-lg">
              Sistema integral para gestión mensual de presupuestos, metrados ejecutados, memoria
              valorizada y liquidación de obras. Trazable, auditable y construido al detalle como un
              plano.
            </p>
          ...
          <ol className="mt-12 grid gap-px bg-border md:grid-cols-4">
            {[
              ...
              <li key={step} className="bg-card p-6">
                ...
                <div className="mt-3 text-2xl font-bold uppercase tracking-tight">{title}</div>
