...
<<<<<<< HEAD
      ...
      {step === 3 &&
        ...
        (() => {
          ...
          const summaryRows = valTable.filter(
            (r) => r.qtyCurrent > 0 || lines.some((l) => l.item_id === r.item.id),
          );
          void summaryRows;
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                    ...
                    <div className="rounded-md border p-3">
                      ...
                      />
                      <p className="mt-1 text-xs text-muted-foreground">
                        Ingresa el % programado según cronograma.
                      </p>
                    </div>
                  </div>
...
<<<<<<< HEAD
                      <Select
                        ...
                        onValueChange={(v) =>
                          updateDeduction(d.id, { deduction_type: v as DeductionType })
                        }
                      >
